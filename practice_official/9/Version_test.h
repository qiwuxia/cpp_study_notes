...
// as a workaround we define to_string and stods in this file

// Readers can ignore the implemnetations of to_string and stods 
...
inline
double stods(const std::string &s, std::size_t * = 0)
{
	char **buf = 0;
